    ...
    return pipeline(
        [
            node(
                ...
                outputs="merged_satisfaction",
                name="merge_data_and_labels",
            ),
            node(
                func=delete_columns,
                inputs=["merged_satisfaction", "params:columns_to_delete"],
                outputs="cleaned_columns_satisfaction",
                name="delete-unnecessary-columns",
            ),
            node(
                func=rename_columns_in_dataframe,
                inputs="cleaned_columns_satisfaction",
                outputs=["renamed_columns_satisfaction", "names_mapping"],
                name="rename-columns",
            ),
            node(
                func=compute_unique_values,
                inputs=[
                    "renamed_columns_satisfaction",
            ...
            node(
                ...
                inputs=["renamed_columns_satisfaction", "mapping_unique_values"],
