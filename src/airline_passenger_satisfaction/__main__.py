"""airline_passenger_satisfaction file for ensuring the package is executable
as `airline-passenger-satisfaction` and `python -m airline_passenger_satisfaction`
"""
import importlib
